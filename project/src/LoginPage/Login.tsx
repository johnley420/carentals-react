...
const Login: React.FC = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            ...
            // Send plain password to the server
            const data = {
                email: values.email,
                password: values.password, // Send plain password to the server
                recaptchaToken,
            };
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="row">
                            <p>
                                ...
                                <Link
                                    to="/register"
                                    className="buttons btn-outline-primary w-100"
                                >
                                    Create Account
                                </Link>
                            </p>
